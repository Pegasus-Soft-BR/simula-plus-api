...
using MockExams.Helper.Image;
using Xunit;

namespace MockExams.Test.Unit.Helpers
{
    public class HelperTests
    {
        ...
        {
            var expected = @"http://dev.MockExams.com.br/Images/Books/image.jpg";
            var actual = ImageHelper.GenerateImageUrl("image.jpg", "wwwroot/Images/Books", "http://dev.MockExams.com.br");
